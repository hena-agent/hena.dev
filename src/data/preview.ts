    ...
    stages: [
      {
        ...
        steps: [
          {
            kind: "message",
            text: "I am checking the tracked release pages against their previous snapshots. I am separating a genuinely new announcement from a page rewrite before calling it a market signal.",
          },
          {
            kind: "tool",
            label: "Open tracked sources",
            detail: "3 pages · previous snapshots",
            duration: 1900,
          },
          {
            kind: "tool",
            label: "Read release timestamps",
            detail: "Published · updated · archived",
            duration: 1900,
          },
          {
            kind: "observation",
            text: "Repeated announcements are grouped so one release is not counted twice. The remaining changes have a clear source and a date that can be checked later.",
          },
        ],
      },
      {
        ...
        steps: [
          {
            kind: "message",
            text: "Two changes stand out: team controls for shared workspaces and expanded usage reporting. I am comparing the surrounding copy so the digest distinguishes product direction from editorial change.",
          },
          {
            kind: "tool",
            label: "Compare page changes",
            detail: "Feature copy · editorial updates",
            duration: 2000,
          },
          {
            kind: "tool",
            label: "Capture supporting evidence",
            detail: "Workspace controls · usage reports",
            duration: 2000,
          },
          {
            kind: "observation",
            text: "Both suggest a stronger team focus. Neither announcement establishes a pricing change, so I am keeping that absence explicit instead of inferring one.",
          },
        ],
      },
      {
        ...
        steps: [
          {
            kind: "message",
            text: "I am checking the supporting pages before separating what was announced from what it might mean. The final digest will keep rollout timing and plan availability attached to their sources.",
          },
          {
            kind: "tool",
            label: "Verify availability details",
            detail: "Pricing · documentation",
            duration: 2050,
          },
          {
            kind: "tool",
            label: "Assemble weekly digest",
            detail: "Changes · dates · confidence",
            duration: 2050,
          },
          {
            kind: "observation",
            text: "The sourced weekly digest is ready for review, with rollout dates and plan availability left explicit. The conclusion is useful without overstating what the pages support.",
          },
        ],
      },
    ],
